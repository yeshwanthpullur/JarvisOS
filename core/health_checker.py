...
class HealthChecker:
    ...
    def run_all(self) -> tuple[HealthResult, ...]:
        ...
        checks = (
            ...
            self.check_module("local_ai", "Local AI"),
            self.check_module("local_runtime", "Local Runtime"),
            self.check_module("local_models", "Local Models"),
            self.check_module("local_execution_ready", "Local Execution Ready"),
