...
class StartupManager:
    ...
    def start(self) -> None:
        ...
        self.conversation_manager = ConversationManager(
            ...
            coding_agent=self.jarvis_core.manager.coding_agent,
            document_agent=self.jarvis_core.manager.document_agent,
            browser_agent=self.jarvis_core.manager.browser_agent,
            scheduler_agent=self.jarvis_core.manager.scheduler_agent,
            communication_agent=self.jarvis_core.manager.communication_agent,
            adapter_agent=self.jarvis_core.manager.adapter_agent,
            advanced_model_planner=self.jarvis_core.manager.advanced_model_planner,
            advanced_model_runtime=self.jarvis_core.manager.advanced_model_runtime,
            evaluation_runner=self.jarvis_core.manager.evaluation_runner,
            release_readiness_evaluator=self.jarvis_core.manager.release_readiness_evaluator,
            phase4_runtime=self.jarvis_core.manager.phase4_runtime,
