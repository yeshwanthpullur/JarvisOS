...
| Testing/Release Readiness | Working | 90% | 1,393 tests pass and `v0.3.0-alpha` is published. | Full suite; release checklist | Keep release evidence and status docs current. |
