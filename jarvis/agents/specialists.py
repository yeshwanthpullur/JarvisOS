...
def specialist_entries(*, vision_ready: bool = False) -> tuple[E, ...]:
    ...
    future = (
        _entry("research_agent", "Future evidence-oriented research coordinator.", (_cap("research", T.RESEARCH, "Future research planning.", limitations=("future",)),), ready=False, health="future", reason="A research specialist is assigned to a later milestone."),
