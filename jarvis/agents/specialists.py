...
def specialist_entries(*, vision_ready: bool = False) -> tuple[E, ...]:
    current = (
        ...
        _entry("research_agent", "Read-only research planning and bounded evidence summaries.", (_cap("research", T.RESEARCH, "Research planning, evidence requirements, and bounded summaries.", limitations=("Read-only and plan-first; evidence retrieval is limited when read-only web access is unavailable.",)),), ready=False, health="partial_research", reason="Research planning is implemented; source retrieval remains read-only and bounded."),
    ...
    future = (
        ...
        _entry("coding_agent", "Future governed coding specialist.", (_cap("coding", T.CODING, "Future repository and patch planning.", risk=R.HIGH, approval=True, side_effects=("files",), permissions=("write_files",), limitations=("future",)),), ready=False, health="future", reason="Autonomous code modification is not enabled in Phase 3."),
