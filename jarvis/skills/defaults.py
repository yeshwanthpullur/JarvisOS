...
def build_default_skill_registry() -> SkillRegistry:
    builtins = (
        ...
        _ready("research_plan_skill", "research", "research_plan", "Create bounded quick, standard, or deep research plans."),
        _ready("research_query_skill", "research", "research_query", "Generate and deduplicate bounded research queries."),
        _ready("research_search_skill", "research", "research_search", "Use only configured governed read-only search providers.", permissions=(P.NETWORK_ACCESS,)),
        _ready("research_source_rank_skill", "research", "research_source_rank", "Prefer relevant primary sources using explainable signals."),
        _ready("research_retrieve_skill", "research", "research_retrieve", "Coordinate bounded retrieval through existing read policies.", permissions=(P.BROWSER_READ,)),
        _ready("research_evidence_skill", "research", "research_evidence", "Normalize bounded evidence with provenance."),
        _ready("research_verify_skill", "research", "research_verify", "Map claims to supporting and conflicting evidence."),
        _ready("research_contradiction_skill", "research", "research_contradiction", "Represent credible source disagreement explicitly."),
        _ready("research_freshness_skill", "research", "research_freshness", "Track publication, update, and retrieval time separately."),
        ...
        _ready("orchestration_graph_skill","workflow","orchestration_graph","Validate bounded dependency graphs without execution."),
        _ready("orchestration_context_skill","workflow","orchestration_context","Version segmented request-scoped context."),
        _ready("orchestration_message_skill","workflow","orchestration_message","Route immutable session-scoped metadata messages."),
        _ready("orchestration_budget_skill","workflow","orchestration_budget","Enforce finite inherited resource budgets."),
        _ready("orchestration_cancel_skill","workflow","orchestration_cancel","Cooperatively cancel pending orchestration work."),
        _ready("orchestration_observability_skill","workflow","orchestration_observability","Inspect bounded audit and metrics metadata."),
