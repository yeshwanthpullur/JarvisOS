...
class Phase6Runtime:
    ...
    def status(self) -> dict[str, object]:
        return {"phase": 6, "mode": "controlled_local_first", "execution_authority": self.execution_authority, "environment": self.environments.summary(), "models": self.models.summary()}
