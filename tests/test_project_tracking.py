...
class ProjectTrackingTests(unittest.TestCase):
    ...
    def test_project_health_json_is_valid_and_bounded(self) -> None:
        ...
        self.assertEqual(health["next_milestone"], "Awaiting explicit approval for Prompt 53")
        self.assertEqual(health["overall_mvp_readiness"], 84)
        ...
        self.assertEqual(len(health["categories"]), 29)
    ...
    def test_roadmap_covers_completed_and_next_milestones(self) -> None:
        ...
        self.assertIn("Prompt 53 has not started", text)
    ...
    def test_project_status_command_is_concise_and_data_backed(self) -> None:
        ...
        self.assertIn("MVP=84%", response.response)
        self.assertIn("Awaiting explicit approval for Prompt 53", response.response)
        ...
        self.assertEqual(response.metadata["overall_mvp_readiness"], 84)
