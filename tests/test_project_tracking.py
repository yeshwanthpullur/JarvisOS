...
REQUIRED_DOCS = (
    ...
    "ADVANCED_MODEL_RUNTIME.md",
    "NEMOTRON_INTEGRATION.md",
    "NVIDIA_NIM.md",
    "VLLM_RUNTIME.md",
...
class ProjectTrackingTests(unittest.TestCase):
    ...
    def test_project_health_json_is_valid_and_bounded(self) -> None:
        ...
        self.assertEqual(health["next_milestone"], "Prompt 85")
        ...
        self.assertEqual(len(health["categories"]), 34)
    ...
    def test_project_status_command_is_concise_and_data_backed(self) -> None:
        ...
        self.assertIn("next=Prompt 85", response.response)
