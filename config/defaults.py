...
DEFAULT_CONFIG: Final[dict[str, Any]] = {
    ...
    "web_automation":{"enabled":False,"mode":"off","adapter":"unavailable-browser","allow_local_targets":False,"audit_retention":100,"action_timeout_seconds":30,"store_page_content":False,"store_screenshots":False},
    "interface": {
        "enabled": False,
        "host": "127.0.0.1",
        "port": 8765,
