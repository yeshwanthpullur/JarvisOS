...
from config.schema import (
    ...
    WorkflowConfig, ReliabilityConfig, GovernanceConfig,
...
def load_settings(
    ...
    return AppSettings(
        ...
        advanced_models=AdvancedModelsConfig(**raw_config["models_advanced"]),
        evaluation=EvaluationConfig(**raw_config["evaluation"]),
        release_readiness=ReleaseReadinessConfig(**raw_config["release_readiness"]),
        ...
        governance=GovernanceConfig(**raw_config["governance"]),
