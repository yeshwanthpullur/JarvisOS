...
class CommandHelp:
    ...
    def render(self, registry: CommandRegistry) -> str:
        ...
        primary = (
            ...
            ("voice stop/pause/resume", "Control active non-blocking speech"),
            ("voice speaking status", "Show current speech queue state"),
            ("voice interrupt", "Stop speech and capture one explicit interruption"),
            ("voice repeat", "Repeat the last safe spoken reply"),
            ("voice correction <text>", "Stop speech and submit corrected text"),
            ...
            ("vision models", "List installed local Ollama vision readiness"),
            ("vision analyze <path>", "Analyze an image with local Ollama"),
            ("vision describe <path>", "Describe an image with a permitted model"),
            ("vision ask <path> <question>", "Ask a question about an image"),
            ("vision audit", "Show bounded metadata-only vision audit"),
            ("vision cleanup", "Clear vision audit metadata, never user images"),
            ("image status", "Show local image-generation workflow readiness"),
            ("image providers", "List registered local image providers"),
            ("image plan <prompt>", "Validate and dry-run an image request"),
            ("image generate <prompt>", "Run a local image request when a provider exists"),
            ("image safety <prompt>", "Check whether an image request is allowed"),
            ("image history", "Show bounded recent image jobs"),
