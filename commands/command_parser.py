...
_SUBCOMMANDS = {
    "provider list", "provider status", "provider health", "provider current", "provider enable", "provider disable", "provider test", "provider show", "provider capabilities", "provider policy", "provider validate", "provider history",
